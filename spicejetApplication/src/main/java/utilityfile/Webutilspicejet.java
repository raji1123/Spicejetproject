...
public class Webutilspicejet {
	...
	public static void browser(String browser,ChromeOptions option) {
		
		boolean flag=false;
		switch(browser) {
		case "chrome": driver=new ChromeDriver(option);
		flag=true;
		break;
	...
	public static void reports() {
		...
		Reporter=new ExtentHtmlReporter(".//Extentrports//spicjetreports"+".html");
